...
namespace LaravelAdminGoogleAuthenticator\Http\Controllers;
...
use LaravelAdminGoogleAuthenticator\Captcha;

use LaravelAdminGoogleAuthenticator\Core\PHPGangsta_GoogleAuthenticator;
...
class GoogleAuthenticatorController extends Controller {
	...
	public function googleCodeCheck($code){
		...
		if ($google->verifyCode(config('admin.extensions.admin-google-authenticator.secret', ''), $code, 1)) {
			return true;
		}
