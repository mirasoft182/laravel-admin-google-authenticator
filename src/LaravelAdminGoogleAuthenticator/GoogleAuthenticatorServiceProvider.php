...
namespace LaravelAdminGoogleAuthenticator;

use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\ServiceProvider;

use LaravelAdminGoogleAuthenticator\Http\Controllers\GoogleAuthenticatorController;
...
class GoogleAuthenticatorServiceProvider extends ServiceProvider {
	...
	public function boot(GoogleAuthenticator $extension){
		if (!config('admin.extensions.admin-google-authenticator.enable', true)) {
			return;
		}
